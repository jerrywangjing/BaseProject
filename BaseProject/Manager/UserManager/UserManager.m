...
-(void)loginToServer:(NSDictionary *)params completion:(loginBlock)completion{
    ...
    [PPNetworkHelper POST:NSURLFormat(URL_login) parameters:params success:^(id responseObject) {
...
-(void)autoLoginToServer:(loginBlock)completion{
    [PPNetworkHelper POST:NSURLFormat(URL_login) parameters:nil success:^(id responseObject) {
        [self LoginSuccess:responseObject completion:completion];
...
-(BOOL)loadUserInfo{
    ...
    if (userDic) {
        self.curUserInfo = [UserInfo modelWithJSONDic:userDic];
        return YES;
    }
    return NO;
}
