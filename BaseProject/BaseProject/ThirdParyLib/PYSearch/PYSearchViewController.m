...
#define PYTextColor PYColor(25,195,192)  // 文本字体颜色
...
- (BOOL)searchBarShouldBeginEditing:(UISearchBar *)searchBar{
    ...
    if ([self.delegate respondsToSelector:@selector(searchViewControllerShouldBeginSearching:)]) {
        return [self.delegate searchViewControllerShouldBeginSearching:searchBar];
    }
    return YES;
}
...
- (void)searchBarSearchButtonClicked:(UISearchBar *)searchBar
{
    ...
    switch (self.searchResultShowMode) {
        ...
        case PYSearchResultShowModeCustom: // 自定义
            ...
            [self.navigationController pushViewController:self.customSearchResultController animated:YES];
            break;
        default:
            break;
    }
